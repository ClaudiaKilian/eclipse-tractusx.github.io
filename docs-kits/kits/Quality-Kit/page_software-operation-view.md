...
| `(https://purl.org/dc/terms/date`                  | `"JJJ-CW-N"`                                                     | x        | This property identifies an pdate of an already shared catalogue asset. Day is mensioned as calender week day number, e.g. '1' means "monday"                                                                                                                 |
